      ...
      <header className="relative pt-32 pb-24 overflow-hidden" style={{
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <nav className="mb-8 flex items-center gap-2 text-sm font-semibold text-cyan-600 uppercase tracking-[0.25em] flex-wrap">
            <span>PBL</span> <span className="text-gray-300">/</span> <span>Technical Resources</span> <span className="text-gray-300">/</span> <span className="break-words">General Protocols</span>
          </nav>
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-8">
            <span className="text-[#002776]">General</span> <br/> <span className="font-light text-gray-400 font-serif italic">Protocols</span>
          </h1>
