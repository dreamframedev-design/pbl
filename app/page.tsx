...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#FBFBFE] text-[#002776]">
      ...
      <section className="relative w-full flex items-center justify-start lg:items-center min-h-[calc(100dvh-100px)] md:min-h-[calc(100vh-100px)] pt-4 md:pt-32" style={{
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full py-8 md:py-16 lg:py-20">
