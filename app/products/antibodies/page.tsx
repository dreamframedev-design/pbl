    ...
    <main className="min-h-screen bg-[#FBFBFE] text-[#002776]">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-8 text-slate-600 leading-relaxed font-light text-lg">
          ...
          <p>
            PBL&apos;s MAbs are derived against a range of interferons from various mammalian species. They deliver superior product stability and high specificity while providing reliable and reproducible results.
          </p>
        </div>
      </section>
